...
class AudioGraphDelegate: AudioGraphDelegateProtocol {
    ...
    func getVolume() -> Float {
        return round(graph.getVolume() * AppConstants.volumeConversion_graphToUI)
    }
    
    func setVolume(_ volumePercentage: Float) {
        graph.setVolume(volumePercentage * AppConstants.volumeConversion_UIToGraph)
    }
    ...
    func increaseVolume() -> Float {
        ...
        return round(newVolume * AppConstants.volumeConversion_graphToUI)
    }
    ...
    func getBalance() -> Float {
        return round(graph.getBalance() * AppConstants.panConversion_graphToUI)
    }
    
    func setBalance(_ balance: Float) {
        graph.setBalance(balance * AppConstants.panConversion_UIToGraph)
    }
    ...
    func panLeft() -> Float {
        ...
        return round(newBalance * AppConstants.panConversion_graphToUI)
    }
    ...
    func setPitch(_ pitch: Float) -> String {
        ...
        graph.setPitch(pitch * AppConstants.pitchConversion_UIToGraph)
